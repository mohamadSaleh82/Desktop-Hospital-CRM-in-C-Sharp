...
namespace EPatient.Views.Operator
{
    public partial class ReservationsControl : MetroFramework.Controls.MetroUserControl
    {
        ...
        private DataTable FillTable(String search = null, DateTime? date = null)
        {
            ...
            dataTable.Columns.Add("بیمار");
            dataTable.Columns.Add("خدمات");
            dataTable.Columns.Add("تاریخ");
            dataTable.Columns.Add("مسئول");
            dataTable.Columns.Add("وضعیت پرداخت");
            dataTable.Columns.Add("وضعیت");
            dataTable.Columns.Add("قیمت");
            ...
            foreach (var reservation in reservations)
            {
                ...
                row["بیمار"] = reservation.PatientName + " " + reservation.PatientSurname;
                row["خدمات"] = reservation.ServiceName;
                row["تاریخ"] = reservation.StartTime;
                row["مسئول"] = reservation.UserName + " " + reservation.UserSurname;
                row["وضعیت پرداخت"] = reservation.Paid ? "Yes" : "No";
                row["وضعیت"] = reservation.Done ? "Yes" : "No";
                row["قیمت"] = reservation.Price + "تومان";
